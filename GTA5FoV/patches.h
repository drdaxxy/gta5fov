...
{
	0x40, 0x8A, 0xAC, 0x24, 0xA0, 0x00, 0x00, 0x00, 0x80, 0xA3, 0x7E, 0x07, 0x00, 0x00, 0xFB
};
char firstPersonCrouchingCode[] =
{
	...
	0x80, 0xA3, 0x7E, 0x07, 0x00, 0x00, 0xFB,		// and byte ptr [rbx+0000077E], -05 (copied)
	0x49, 0xBB,										// mov r11, 
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,	// (return jump address)
	0x41, 0xFF, 0xE3								// jmp r11
};
...
{
	0x8A, 0x83, 0x89, 0x07, 0x00, 0x00, 0xF3, 0x0F, 0x11, 0x83, 0xB4, 0x05, 0x00, 0x00, 0xA8, 0x04
};
char firstPersonADSCode[] =
{
	0xC7, 0x83, 0xB4, 0x05, 0x00, 0x00,				// mov [rbx+000005B4], 
	0x00, 0x00, 0x88, 0x42,							// (fov - default 68)
	0x8A, 0x83, 0x89, 0x07, 0x00, 0x00,				// mov al,[rbx+00000789] (copied over)
	0x49, 0xBB,										// mov r11, 
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,	// (return jump address)
	0x41, 0xFF, 0xE3								// jmp r11
};
