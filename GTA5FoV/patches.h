...
{
	0xF3, 0x44, 0x0F, 0x11, 0x4D, 0x00, 0x8B, 0x86, 0xC0, 0x13, 0x00, 0x00, 0xC1, 0xE8, 0x1E
...
char firstPersonWalkingCode[] =
{
	...
	0x8B, 0x86, 0xC0, 0x13, 0x00, 0x00,				// mov eax,[rsi+000013C0] (copied over)
...
{
	0x40, 0x8A, 0xAC, 0x24, 0xA0, 0x00, 0x00, 0x00, 0x80, 0xA3, 0x82, 0x07, 0x00, 0x00, 0xFB
//	40 8A AC 24 ?? ?? ?? ?? 80 A3 ?? ?? ?? ?? FB
};
char firstPersonCrouchingCode[] =
{
	0xC7, 0x45, 0x00,								// mov [rbp+00],
	0x00, 0x00, 0x88, 0x42,							// (fov - default 68)
	0x40, 0x8A, 0xAC, 0x24, 0xA0, 0x00, 0x00, 0x00,	// mov bpl, [rsp+000000A0] (copied)
	0x80, 0xA3, 0x82, 0x07, 0x00, 0x00, 0xFB,		// and byte ptr [rbx+00000782], -05 (copied)
	0x49, 0xBB,										// mov r11, 
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,	// (return jump address)
	0x41, 0xFF, 0xE3								// jmp r11
};
